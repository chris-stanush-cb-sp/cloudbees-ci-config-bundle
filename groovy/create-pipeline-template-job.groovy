...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/chris-stanush-cb-sp/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>chris-stanush-cb-sp</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>chris-stanush-cb-sp</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/chris-stanush-cb-sp/pipeline-template-catalog.git</repositoryUrl>
              <traits>
